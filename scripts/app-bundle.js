...
define('shopping-cart-item',['exports', 'aurelia-framework'], function (exports, _aureliaFramework) {
  'use strict';
  ...
  var ShoppingCartItem = exports.ShoppingCartItem = (_class = function ShoppingCartItem() {
    _classCallCheck(this, ShoppingCartItem);

    _initDefineProp(this, 'id', _descriptor, this);

    _initDefineProp(this, 'quantity', _descriptor2, this);
  }, (_descriptor = _applyDecoratedDescriptor(_class.prototype, 'id', [_aureliaFramework.bindable], {
    enumerable: true,
    initializer: null
  }), _descriptor2 = _applyDecoratedDescriptor(_class.prototype, 'quantity', [_aureliaFramework.bindable], {
    enumerable: true,
    initializer: null
  })), _class);
});
...
define('text!product-list.html', ['module'], function(module) { module.exports = "<template><require from=\"./product-card\"></require><div class=\"product-list uk-grid-large\" uk-grid uk-height-match=\"target: > div > .uk-card\"><div repeat.for=\"product of products\" class=\"uk-width-1-2@s uk-width-1-3@m uk-width-1-4@l\"><product-card id=\"${product.id}\" name=\"${product.name}\" description=\"${product.description}\"></product-card></div></div></template>"; });
define('text!shopping-cart-item.html', ['module'], function(module) { module.exports = "<template><div class=\"cart-list uk-description-list uk-margin-small-bottom\"><dt>Crap <a href=\"#\"><span class=\"uk-badge\">x</span></a></dt><dd><div class=\"uk-grid-small uk-margin-remove-top\" uk-grid><div class=\"uk-width-expand\" uk-leader>Quantity</div><div><a href=\"#\">-</a> <span>${quantity}</span> <a href=\"#\">+</a></div></div><div class=\"uk-grid-small uk-margin-remove-top\" uk-grid><div class=\"uk-width-expand\" uk-leader>Price (each)</div><div>$10.00</div></div><div class=\"uk-grid-small uk-margin-remove-top\" uk-grid><div class=\"uk-width-expand\" uk-leader>Price (subtotal)</div><div>$40.00</div></div></dd></div><style>.cart-list dt{color:#ecf0f1}.cart-list dd{font-size:.8em}</style></template>"; });
define('text!shopping-cart.html', ['module'], function(module) { module.exports = "<template><require from=\"./shopping-cart-item\"></require><div repeat.for=\"id of cartArr\">${id}</div><div id=\"shopping-cart\" uk-offcanvas><div class=\"uk-offcanvas-bar\"><button class=\"uk-offcanvas-close\" type=\"button\" uk-close></button><div class=\"uk-text-center uk-margin-medium-bottom\"><h3>Your Cart</h3><button class=\"uk-button uk-button-primary\">Checkout</button></div><shopping-cart-item id.bind=\"id\" quantity.bind=\"quantity\" repeat.for=\"[id, quantity] of cart\"></shopping-cart-item><h4 class=\"uk-margin-small-top\">Total</h4><div id=\"totals\"><div class=\"uk-grid-small uk-margin-remove-top\" uk-grid><div class=\"uk-width-expand\" uk-leader>Subtotal</div><div>$69.69</div></div><div class=\"uk-grid-small uk-margin-remove-top\" uk-grid><div class=\"uk-width-expand\" uk-leader>Taxes (13%)</div><div>$69.69</div></div><div class=\"uk-grid-small uk-margin-remove-top\" uk-grid><div class=\"uk-width-expand\" uk-leader>Shipping</div><div>$12.69</div></div><div class=\"uk-grid-small uk-margin-remove-top\" uk-grid><div class=\"uk-width-expand\" uk-leader>Total</div><div>$99.99</div></div></div></div></div><style>#totals{font-size:.9em}</style></template>"; });
